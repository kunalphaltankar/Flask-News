...
def home():
	...
	form = QueryForm()
	title = 'Home'
	(title,url) = form.on_submit(url,title) #if search form is submitted
	
	category = request.args.get('category')# if category exits
	if category:
		title = category.capitalize()
		url = 'https://newsapi.org/v2/top-headlines?country=in&category=' + category + '&apiKey=afc81dd95663478a88bc39e5cdc851ec'
...
# sava_picture() is auxilary funtion for image conversion and savind image in it 'static/profile_pics'
